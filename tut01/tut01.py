...
try:
    with open('tut01/octant_input.csv', 'r') as read_obj, \
            open('tut01/output.csv', 'w', newline='') as write_obj:
...
try:
    with open('tut01/output.csv', 'r',newline='') as f:
...
df = pd.read_csv("tut01/output.csv")  
...
# saving the csv file
df.to_csv("tut01/output.csv",index=False)
